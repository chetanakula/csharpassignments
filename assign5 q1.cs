...
namespace ConsoleApp3
{
    internal class Class1
    {
        public static void Main()
        {
            ...
            Array.Copy(chetan, satya, 2);
            Console.WriteLine(" Copied string elements:");
            foreach (string j in satya)
            {
                Console.WriteLine(j + " ");
            }
            Console.ReadLine();

            Array.Clear(chetan, 1,2);
